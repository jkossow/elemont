 ...
 * @author jkossow
 */
public class EtykietaQR4  extends Etykieta {
    ...
    public EtykietaQR4( Odcinek o, SelektorZawieszki selektor) {
        this.qr4 =  new QR4( o, selektor );
    ...
    public String printerString() {
        return  "^XA\n" +
                ...
                "^FO50,30^BQN,2,6^FDMA," + qr4.encode() + "^FS\n" +
                "^XZ";
