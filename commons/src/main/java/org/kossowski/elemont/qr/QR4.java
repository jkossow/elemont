 ...
 * @author jkossow
 */
public class QR4 extends QR {

    private static final String QR4Prefix = "04;";
    
    private Long id_odcinka;
    private SelektorZawieszki selektor;
    
    public QR4( Odcinek odcinek, SelektorZawieszki selektor ) {
    ...
    public String encode() {
        return QR4Prefix + id_odcinka + selektor;
    }
